...
// List lists all Repos in the indexer.
func (s *repoLister) List(selector labels.Selector) (ret []*v1beta1.Repo, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.Repo))
	})
	return ret, err
}
...
type RepoNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1beta1.Repo, error)
...
// List lists all Repos in the indexer for a given namespace.
func (s repoNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.Repo, err error) {
...
// Get retrieves the Repo from the indexer for a given namespace and name.
func (s repoNamespaceLister) Get(name string) (*v1beta1.Repo, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("repo"), name)
	}
	return obj.(*v1beta1.Repo), nil
}
