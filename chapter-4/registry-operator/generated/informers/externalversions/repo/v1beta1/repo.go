...
import (
	...
	versioned "setting.zhihu.com/generated/clientset/versioned"
	internalinterfaces "setting.zhihu.com/generated/informers/externalversions/internalinterfaces"
	v1beta1 "setting.zhihu.com/generated/listers/repo/v1beta1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RepoV1beta1().Repos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RepoV1beta1().Repos(namespace).Watch(context.TODO(), options)
			},
		},
		&repov1beta1.Repo{},
		resyncPeriod,
...
func (f *repoInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&repov1beta1.Repo{}, f.defaultInformer)
}

func (f *repoInformer) Lister() v1beta1.RepoLister {
	return v1beta1.NewRepoLister(f.Informer().GetIndexer())
}
