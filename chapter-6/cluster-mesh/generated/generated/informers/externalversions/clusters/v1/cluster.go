...
import (
	...
	versioned "zhihu.com/cluster-mesh/generated/clientset/versioned"
	internalinterfaces "zhihu.com/cluster-mesh/generated/informers/externalversions/internalinterfaces"
	v1 "zhihu.com/cluster-mesh/generated/listers/clusters/v1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ClustersV1().Clusters().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClustersV1().Clusters().Watch(context.TODO(), options)
			},
		},
		&clustersv1.Cluster{},
		resyncPeriod,
